...
async function main() {
  ...
  const book1 = await prisma.book.create({
    data: {
      ...
      publisherLink: 'https://harpercollins.com',
  ...
  const book2 = await prisma.book.create({
    data: {
      ...
      amazonLink: 'https://amazon.com',
      googleBooksLink: 'https://books.google.com',
      publisherLink: 'https://oxford.com',
  ...
  await prisma.article.create({
    data: {
      ...
      userId: admin.id,
      excerpt: 'In an age dominated by performative noise, this essay explores how deliberate quietness and strategic withdraw form the core of authentic long-term activism.',
